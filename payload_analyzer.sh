...
# This script's goal is to decode any hex data and translate it to english.
# Python3: It's also necessary to have libretranslatepy library installed found at: https://github.com/argosopentech/LibreTranslate-py
# Example:
...
function decoder {
    ...
    translated_hex=$(python3 libretranslator.py "$hex_data")
